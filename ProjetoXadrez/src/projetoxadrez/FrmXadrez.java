...
public class FrmXadrez extends javax.swing.JFrame {
    ...
    private static Posicao origem = new Posicao(8, 8);
    private static Posicao destino = new Posicao(8, 8);
    ...
    private static void jogo(int linha, int coluna) {
        if (origem.getLinha() > 7 || origem.getColuna() > 7) {
            if (partida.validarAtribuicaoOrigem(new Posicao(linha, coluna))) {
                origem.setValores(linha, coluna);
                imprimirMovimentosPossiveis(linha, coluna);
            }
        } else if (destino.getLinha() > 7 || destino.getColuna() > 7) {
            if (partida.validarAtribuicaoDestino(origem, new Posicao(linha, coluna))) {
                destino.setValores(linha, coluna);
                ...
                origem.setValores(8, 8);
                destino.setValores(8, 8);
